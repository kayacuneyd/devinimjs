...
| [TASK-004](tasks/TASK-004-data-table-pagination-filtering.md) — `dv-data-table` pagination/filtering | In progress | claude (this session) | `swarm/task-004-data-table-pagination-filtering` | Implementation |
| [TASK-005](tasks/TASK-005-pagination-page-list.md) — `dv-pagination` page-number list/jump-to-page | In progress | claude (this session) | `swarm/task-005-pagination-page-list` | Implementation |
| [TASK-006](tasks/TASK-006-modal-focus-trap.md) — `dv-modal` focus-trap/nested-modal | In progress | claude (this session) | `swarm/task-006-modal-focus-trap` | Implementation |
